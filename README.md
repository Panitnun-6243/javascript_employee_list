## Employee list
This basic CRUD web app can manage the list of employee. I create for review a basic of html, bootstrap and js to create a fullstack site without frontend framework.
